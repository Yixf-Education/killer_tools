...
* [ClusterGVis](https://github.com/junjunlab/ClusterGVis): One-step to Cluster and Visualize Gene Expression Matrix
...
* [fastCNV](https://github.com/must-bioinfo/fastCNV): fastCNV R package to detect putative CNVs in single cell and spatial transcriptomics data
* [fastml](https://cran.r-project.org/web/packages/fastml/index.html): Fast Machine Learning Model Training and Evaluation
...
* [gtUtils](https://gtutils.aweatherman.com/): a collection of themes, coloring functions, and other utilities to enhance and extend the functionality of the [gt](https://gt.rstudio.com/) package for creating beautiful tables in R
...
* [gVenn](https://github.com/ckntav/gVenn): Proportional Venn diagrams for genomic regions and gene set overlaps
...
* [meta](https://cran.r-project.org/web/packages/meta/index.html): General Package for Meta-Analysis
...
* [MultiModalGraphics](https://github.com/famanalytics0/MultiModalGraphics): A unified R/Bioconductor package for creating publication-quality volcano plots and custom heatmaps from diverse biological data sources.****
* [multiROC](https://cran.r-project.org/web/packages/multiROC/index.html): Calculating and Visualizing ROC and PR Curves Across Multi-Class Classifications
...
* [scrnapip](https://github.com/OpenGene/scrnapip): A Systematic and Dynamic Pipeline for Single-Cell RNA Sequencing Analysis
...
* [cellassign](https://github.com/irrationone/cellassign): Automated, probabilistic assignment of cell types in scRNA-seq data
* [DRAGON](https://github.com/arc85/dragonsc): Deterministic annealing gaussian mixtures models for single cell RNAseq
* [singleseqgset](https://github.com/arc85/singleseqgset): Gene set enrichment analysis for single-cell RNAseq data
* [celltalker](https://github.com/arc85/celltalker): Inference of cell-cell communication from single-cell RNAseq data
* [DPT](https://bioinformaticshome.com/tools/rna-seq/descriptions/DPT.html): estimate the temporal order of differentiating cell in single-cell RNA-seq (scRNA-seq) data
* [diffusionMap](https://github.com/rcannood/diffusionMap)
* [destiny](http://www.bioconductor.org/packages/release/bioc/html/destiny.html): Creates diffusion maps
* [iCellR](https://cran.r-project.org/web/packages/iCellR/index.html): Analyzing High-Throughput Single Cell Sequencing Data
* [presto](https://github.com/immunogenomics/presto): Presto performs a fast Wilcoxon rank sum test and auROC analysis
* [harmony](https://github.com/immunogenomics/harmony): Fast, sensitive and accurate integration of single-cell data with Harmony
* [ESTIMATE](https://bioinformatics.mdanderson.org/public-software/estimate/): Estimation of STromal and Immune cells in MAlignant Tumor tissues using Expression data
...
* [CellPhoneDB](https://github.com/Teichlab/cellphonedb): CellPhoneDB can be used to search for a particular ligand/receptor, or interrogate your own single-cell transcriptomics data.
* [clustermole](https://cran.r-project.org/web/packages/clustermole/index.html): Unbiased Single-Cell Transcriptomic Data Cell Type Identification
* [CellChat](https://github.com/sqjin/CellChat/): Inference and analysis of cell-cell communication
* [iTALK](https://github.com/Coolgenome/iTALK): is an R toolkit for characterizing and illustrating intercellular communication
* [SciBet](http://scibet.cancer-pku.cn/): Single Cell Identificator Based on E-test (SciBet) is a computational tool for predicting cell identity for any randomly sequenced cell by single cell RNA sequencing technique
* [CHETAH](https://github.com/jdekanter/CHETAH): a selective, hierarchical cell type identification method for single-cell RNA sequencing
* [dyno](https://github.com/dynverse/dyno): Inferring trajectories with 60 TI methods
* [Scanpy](https://github.com/theislab/scanpy): Single-Cell Analysis in Python
* [singleseqgset](https://github.com/arc85/singleseqgset): package for gene set enrichment analysis for single-cell RNAseq data
* [clustree](https://cran.r-project.org/web/packages/clustree/index.html): Visualise Clusterings at Different Resolutions
* [batchelor](https://bioconductor.org/packages/release/bioc/html/batchelor.html): Single-Cell Batch Correction Methods
* [presto](https://github.com/immunogenomics/presto): Presto performs a fast Wilcoxon rank sum test and auROC analysis. Latest benchmark ran 1 million observations, 1K features, and 10 groups in 16 seconds (sparse input) and 85 seconds (dense input).
* [SoupX](https://cran.r-project.org/web/packages/SoupX/index.html): Single Cell mRNA Soup eXterminator
* [liger](https://github.com/MacoskoLab/liger): Linked Inference of Genomic Experimental Relationships, LIGER (`liger`) is a package for integrating and analyzing multiple single-cell datasets
* [RcisTarget](https://www.bioconductor.org/packages/release/bioc/html/RcisTarget.html): Identify transcription factor binding motifs enriched on a gene list
* [AUCell](http://bioconductor.org/packages/release/bioc/html/AUCell.html): Analysis of 'gene set' activity in single-cell RNA-seq data (e.g. identify cells with specific gene signatures)
...
* [SPOTlight](https://github.com/MarcElosua/SPOTlight): The goal of **SPOTlight** is to provide a tool that enables the deconvolution of cell types and cell type proportions present within each capture locations comprising mixtures of cells, originally developed for 10X’s Visium - spatial trancsiptomics- technology, it can be used for all technologies returning mixtures of cells.
* [iCellR](https://cran.r-project.org/web/packages/iCellR/index.html): Analyzing High-Throughput Single Cell Sequencing Data
* [ncborcherding/escape](https://github.com/ncborcherding/escape): Easy single cell analysis platform for enrichment
* [xCell](https://github.com/dviraran/xCell): cell types enrichment analysis
...
* [RCTD](https://github.com/dmcable/RCTD): Robust Cell Type Decomposition
* [RCAv2](https://github.com/prabhakarlab/RCAv2): R package for robust clustering of single cell RNA sequencing data
* [seurat-wrappers](https://github.com/satijalab/seurat-wrappers): Community-provided extensions to Seurat
* [seurat-disk](https://github.com/mojaveazure/seurat-disk): Interfaces for HDF5-based Single Cell File Formats
* [scVelo](https://scvelo.readthedocs.io/): RNA velocity generalized through dynamical modeling
* [DeepSEM](https://github.com/HantaoShu/DeepSEM): a deep-learning-based approach with novel neural network architecture that can infer gene regulatory network, embed scRNA-seq data, and simulate realistic scRNA-seq data by interpreting different modules
* [velocyto.R](https://github.com/velocyto-team/velocyto.R): RNA velocity estimation in R
* [SPOTlight](https://github.com/MarcElosua/SPOTlight): Spatial Transcriptomics Capture Location Deconvolution
* [stereoscope](https://github.com/almaan/stereoscope): Spatial mapping of cell types by integration of transcriptomics data
* [ArchR]: Analysis of Regulatory Chromatin in R (www.ArchRProject.com)
* [SnapATAC](https://github.com/r3fang/SnapATAC): Analysis Pipeline for Single Cell ATAC-seq
* [signac](https://github.com/timoast/signac): R toolkit for the analysis of single-cell chromatin data
...
* [Seurat](https://satijalab.org/seurat/): Tools for Single Cell Genomics
...
* [scrublet](https://github.com/swolock/scrublet): Detect doublets in single-cell RNA-seq data
* [DoubletFinder](https://github.com/chris-mcginnis-ucsf/DoubletFinder): R package for detecting doublets in single-cell RNA sequencing data
...
* [netbiolab/scHumanNet](https://github.com/netbiolab/scHumanNet): Analysis cell-type-specific functional gene network, with SCINET and HumanNetv3
* [dpeerlab/SEACells](https://github.com/dpeerlab/SEACells): SEACells algorithm for Inference of transcriptional and epigenomic cellular states from single-cell genomics data

### GPT

* [GitHub - bowang-lab/scGPT](https://github.com/bowang-lab/scGPT?tab=readme-ov-file): Towards Building a Foundation Model for Single-Cell Multi-omics Using Generative AI

### 可视化

* [收藏几个单细胞可视化包](https://mp.weixin.qq.com/s/FvdQhauIXGWw9raxuIyvAg)
* [Publication Quality Plots for Single Cell Data Analysis • scplotter](https://pwwang.github.io/scplotter/)
* [TheHumphreysLab/plot1cell](https://github.com/TheHumphreysLab/plot1cell)
...
* [PROGgene](http://genomics.jefferson.edu/proggene/)
* [SurvExpress](http://bioinformatica.mty.itesm.mx:8080/Biomatec/SurvivaX.jsp)
* [KM-express](http://ec2-52-201-246-161.compute-1.amazonaws.com/kmexpress/index.php)
* [PrognoScan](http://dna00.bio.kyutech.ac.jp/PrognoScan/index.html)
* [lnCAR: lncRNA Explorer](https://lncar.renlab.org/)
* [UALCAN](http://ualcan.path.uab.edu/analysis.html)
* [OncoLnc](http://www.oncolnc.org/)
* [OncomiR](http://www.oncomir.org)
* [MethSurv](https://biit.cs.ut.ee/methsurv/)
* [BloodSpot](http://servers.binf.ku.dk/bloodspot/)
* [GEPIA 2](http://gepia2.cancer-pku.cn/#survival)
* [GenomicScape](http://www.genomicscape.com/microarray/survival.php)
* [ExSurv](https://exsurv.soic.iupui.edu/)
* [LOGpc](http://bioinfo.henu.edu.cn/DatabaseList.jsp)
...
* [rcrossref](https://cran.r-project.org/web/packages/rcrossref/index.html): Client for Various 'CrossRef' 'APIs'
* [crminer](https://cran.r-project.org/web/packages/crminer/index.html): Fetch 'Scholary' Full Text from 'Crossref'
